    ...
    <article class="group">
      <div class="group btmspace-80">        
        ...
        <div class="three_quarter" align="center">
         ...
         <form action="InformParents" method="post"> 
        <table align="center" border="10"  cellpadding="5" cellspacing="5"> 
			...
			/* 	PreparedStatement ps1=con.prepareStatement("select * from studentreg where mobile=?");
				...
				if(rs.next())
				{
					...
					<%--   
					 <tr>
					  <td rowspan="5"><%=rs.getString("mobile") %></td>
					</tr> --%>
				...
				<tr>
					  <td colspan="6" align="center"><a href="marks.jsp?done" style="font-size: 15px; font-weight: bold;"><input type="submit" class="button" name="submit" value="Inform to Parents"/></a></td>
				</tr>
         </table>
        </div>
      </div>
